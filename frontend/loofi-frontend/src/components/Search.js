...
function Search({isChecked}) {
    ...
    return (
        <>
            ...
            <Form.Check type="switch" disabled={true} checked={true} onChange={handleToggle} id="search-toggle"
                        className="ms-3" style={{transform: 'scale(1.5)'}}/>
            ...
            <Form className="d-flex w-50">
                ...
                />
                <NavLink type="button" variant="light" onClick={onSubmit}><Image/><Image src={Search_SVG}
